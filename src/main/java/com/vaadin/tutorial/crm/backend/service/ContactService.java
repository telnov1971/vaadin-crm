...
// класс сервиса для контактов готовый для внедрения
@Service
public class ContactService {
    ...
    // метод выполняется после создания класса контакта
    @PostConstruct
    public void populateTestData() {
        // если в БД нет компаний создается три
        ...
        // если в БД нет контактов создаются несколько со случайной привязкой к компании
